...
test("Length of input isn't multiple 16", t => {
  const plainTextLengthNotMultiple16 = 
    `AES is a ‘symmetric block cipher’ for encrypting texts which can be decrypted with the original encryption key.`
  const expected = 
    `ZEJEYgD/MWqRp/tqYk1VFldNZXWj3pL53hlYtgxeQGGGivFbxQ6j2g3t6etPzoURf15i8CIxapyG10pmuPO+gE9h97lluexfbKPqLpqsHIwxVwEyQFjhYE8xl16J12jFxpnOp2CSXhzavHU1snCcR7FEprwABU6JEcZ/TvCFnL0=`
